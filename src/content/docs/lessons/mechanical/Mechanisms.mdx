...
Mechanical members should also be expected to participate and be part of the designing process to further understand the decisions to do with the robot design as said before. I personally think understanding and designing the bot is 50% of what it means to be a mechanical member. This skill is also important if yourself was ever to pursue to a career in STEM.
...
* Weaknesses:
  * Harder to code
  * Can drag on the carpet![](/lesson-images/mechanical/Mechanisms/Figure_2.png)
...
!\[Swerve\_Chasis]\(/lesson-images/mechanical/Mechanisms/swerve\_drivetrain.png)
